...
export default function MainPage() {
    ...
    async function getAllNews() {
        let { data } = await axios.get(`https://newsapi.org/v2/top-headlines?country=us&apiKey=c556647584a1474c8d94f35284b9bd9b`)
    ...
    return <>
        ...
        <div className="container my-5">
            <div className="row justify-content-center mt-5 pt-5 g-3">
                {allNews.map((article) =>

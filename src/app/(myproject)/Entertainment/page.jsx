...
export default function Entertainment() {
    ...
    async function getAllNews() {
        let { data } = await axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=c556647584a1474c8d94f35284b9bd9b`)
    ...
    return <>
        ...
        <div className="container my-5">
            <h3 className='text-center text-success m-0 my-3 pt-5'>Entertainment News</h3>
